...
public class MiscMath {
    ...
    public static double getConstant(double amount_to_add, double per_x_seconds) {
        ...
        return (amount_to_add / (per_x_seconds * 1000))*GameScreen.DELTA_TIME;
    }
     ...
     */
    public static boolean pointIntersects(double x, double y, double rx, double ry, double rw, double rh) {
        if (x > rx && x < rx + rw) {
            if (y > ry && y < ry + rh) {
                return true;
            }
